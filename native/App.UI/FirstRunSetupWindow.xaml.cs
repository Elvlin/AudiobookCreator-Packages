...
public partial class FirstRunSetupWindow : Window, INotifyPropertyChanged
{
    ...
    public FirstRunSetupWindow(string? installDirectory = null)
    {
        InitializeComponent();
        ...
        _selection.InstallDirectory = string.IsNullOrWhiteSpace(installDirectory)
            ? _setupConfig.DefaultInstallDir
            : Path.GetFullPath(installDirectory);
        InstallDirectoryTextBox.Text = _selection.InstallDirectory;
        InstallDirectoryTextBox.IsReadOnly = true;
